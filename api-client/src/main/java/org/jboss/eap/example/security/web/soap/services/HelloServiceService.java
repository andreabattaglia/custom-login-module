 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://services.soap.web.security.example.eap.jboss.org/", wsdlLocation = "http://localhost:8080/securedws/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://services.soap.web.security.example.eap.jboss.org/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/securedws/HelloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://services.soap.web.security.example.eap.jboss.org/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.soap.web.security.example.eap.jboss.org/", "HelloServicePort"), HelloService.class, features);
    }
